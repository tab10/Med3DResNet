...
def parse_args():
    ...
    parser.add_argument('--path', type=str, default="/Volumes/APPLE SSD/acv_image_data/", help="Path to image data")
    parser.add_argument('--data_flag', type=str, default='affine', help="affine or projection (type of image data to train with")
